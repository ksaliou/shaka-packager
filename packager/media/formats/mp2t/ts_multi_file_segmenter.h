...
#ifndef PACKAGER_MEDIA_FORMATS_MP2T_TS_MULTI_FILE_SEGMENTER_H_
#define PACKAGER_MEDIA_FORMATS_MP2T_TS_MULTI_FILE_SEGMENTER_H_
...
// segmenters.
class TsMultiFileSegmenter : public TsSegmenter {
 public:
  ...
  TsMultiFileSegmenter(const MuxerOptions& options, MuxerListener* listener);
  ~TsMultiFileSegmenter();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(TsMultiFileSegmenter);
};

}  // namespace mp2t
}  // namespace media
}  // namespace shaka
#endif  // PACKAGER_MEDIA_FORMATS_MP2T_TS_MULTI_FILE_SEGMENTER_H_
